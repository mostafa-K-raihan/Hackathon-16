		...
		return(
			<div className="product">
				<table>
					<tr>
						<td>
							<img className="productImg" src={commonIcon} />
						</td>
						<td><small>
...
var SongList = React.createClass({
	...
	loadProducts: function(step) {
		...
		$.ajax({
			url: baseurl+'index.php/Api_controller/getSearchResult',
			method: "POST",
			data: {
				page: this.state.page+step,
				keywords: $("#searchQ").text()
			},
			dataType: 'json',
...
$(document).ready(function(){
    document.getElementById("searchText").value = $("#searchQ").text();
    React.render(<SongList />, document.getElementById('searchResult'));
});
